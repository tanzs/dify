...
from models.model import App, AppAnnotationHitHistory, AppAnnotationSetting, Message, MessageAnnotation, EndUser
...
class AppAnnotationService:
    ...
    def get_annotation_list_all_by_app_id(cls,  user: Union[Account, EndUser], app_id: str, question: str = None, time: str = None,
        ...
        if question:
            filters.append(MessageAnnotation.question.ilike(f"%{question}%"))
